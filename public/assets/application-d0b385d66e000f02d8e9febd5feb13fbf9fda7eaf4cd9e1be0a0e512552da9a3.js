...
$(function (){
  ...
  function putTxt(count){
    $("#new_note").append('<div class="draggable"><textarea name="note[note_texts_attributes]['+count+'][text]" id="note_note_texts_attributes_['+count+']_text" value="['+count+']_class="[draggable]"></textarea></div>');
  }
